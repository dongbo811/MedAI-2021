...
def train(train_loader, model, optimizer, epoch, test_path):
    ...
    test1path = '/home/hhedeeplearning/share/dongbo/CODE/DATASET/uuUNet_raw/KS/'
    if (epoch + 1) % 1 == 0:
...
if __name__ == '__main__':
    ...
    for id in range(1, 6):
        ...
        parser.add_argument('--train_path', type=str,
                            default='/home/hhedeeplearning/share/dongbo/CODE/DATASET/uuUNet_raw/KS/' + id + '_train/',
                            help='path to train dataset')

        parser.add_argument('--test_path', type=str,
                            default='/home/hhedeeplearning/share/dongbo/CODE/DATASET/uuUNet_raw/KS/' + id + '_test/',
                            help='path to testing Kvasir dataset')

        parser.add_argument('--train_save', type=str,
                            default='/home/hhedeeplearning/share/dongbo/DATA/Kvasir-SEG/Polyp-PVT-main/model_pth/' + id + '_' + model_name + '/')

        opt = parser.parse_args()
        logging.basicConfig(filename='/home/hhedeeplearning/share/dongbo/DATA/Kvasir-SEG/Polyp-PVT-main/' + id + '_train_log.log',
