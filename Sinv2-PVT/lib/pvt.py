...
class PolypPVT(nn.Module):
    def __init__(self, num_classes=1, drop_rate=0.2, normal_init=True, pretrained=False):
        ...
        self.resnet = resnet()
        if pretrained:
            self.resnet.load_state_dict(torch.load('E:\master\com\Polyp_NORA\code\TransFuse-main/resnet34-43635321.pth'))
        ...
        self.up_c = BiFusion_block(ch_1=256, ch_2=512, r_2=4, ch_int=256, ch_out=256, drop_rate=drop_rate/2)

        self.up_c_1_1 = BiFusion_block(ch_1=128, ch_2=320, r_2=2, ch_int=128, ch_out=128, drop_rate=drop_rate/2)
        self.up_c_1_2 = Up(in_ch1=256, out_ch=128, in_ch2=128, attn=True)

        self.up_c_2_1 = BiFusion_block(ch_1=64, ch_2=128, r_2=1, ch_int=64, ch_out=64, drop_rate=drop_rate/2)
        self.up_c_2_2 = Up(128, 64, 64, attn=True)

        self.drop = nn.Dropout2d(drop_rate)
        from lib.pvtv2 import pvt_v2_b2
        self.backbone = pvt_v2_b2()  # [64, 128, 320, 512]
        path = '/home/hhedeeplearning/share/dongbo/CODE/pvt_v2_b2.pth'
    ...
    def forward(self, imgs, labels=None):
        ...
        # joint path
        x_c = self.up_c(x_u, x4)

        x_c_1_1 = self.up_c_1_1(x_u_1, x3)
        x_c_1 = self.up_c_1_2(x_c, x_c_1_1)

        x_c_2_1 = self.up_c_2_1(x_u_2, x2)
        ...
        map_1 = F.interpolate(self.final_1(x2), scale_factor=4, mode='bilinear')
